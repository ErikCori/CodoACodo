...
public class Empresa {
    ...
    */
    ...
    public boolean agregarEmpleado(int unLegajo, String unNombre, String unApellido, int dni){
        boolean fueAgregado = false;
        int indice  = buscarLibre();
        if(indice >=0){
        this.empleados[indice].setLegajo(unLegajo);
        this.empleados[indice].setNombre(unNombre);
        this.empleados[indice].setApellido(unApellido);
        this.empleados[indice].setDni(dni);
        this.empleados[indice].setEstado(true);
        fueAgregado = true;
        }
        return fueAgregado;
    }
